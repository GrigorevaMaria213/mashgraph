...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "Shneider Paradise", nullptr, nullptr);
	...
	// -------------------------
	Shader shader("C:\\cpp\\MashGraph\\MashGraph\\5.1.parallax_mapping.vs.txt",
		"C:\\cpp\\MashGraph\\MashGraph\\5.1.parallax_mapping.fs.txt");
	Shader cubeShader("C:\\cpp\\MashGraph\\MashGraph\\cubemaps.vs.txt",
		"C:\\cpp\\MashGraph\\MashGraph\\cubemaps.fs.txt");
	Shader skyboxShader("C:\\cpp\\MashGraph\\MashGraph\\skybox.vs.txt",
		"C:\\cpp\\MashGraph\\MashGraph\\skybox.fs.txt");
	Shader refractionShader("C:\\cpp\\MashGraph\\MashGraph\\refraction.vs.txt",
		"C:\\cpp\\MashGraph\\MashGraph\\refraction.fs.txt");
	Shader lampShader("C:\\cpp\\MashGraph\\MashGraph\\lamp.vs.txt",
		"C:\\cpp\\MashGraph\\MashGraph\\lamp.frag.txt");
	Shader windowShader("C:\\cpp\\MashGraph\\MashGraph\\window.ver", "C:\\cpp\\MashGraph\\MashGraph\\window.fr");  ////смешивание
	...
	// load textures
	// -------------
	unsigned int diffuseMap = loadTexture("C:\\cpp\\MashGraph\\MashGraph\\bricks2.jpg");
	unsigned int normalMap = loadTexture("C:\\cpp\\MashGraph\\MashGraph\\bricks2_normal.jpg");
	unsigned int heightMap = loadTexture("C:\\cpp\\MashGraph\\MashGraph\\bricks2_disp.jpg");
	unsigned int windowTexture = loadTexture("C:\\cpp\\MashGraph\\MashGraph\\window.png");


	std::vector<std::string> faces
	{
		"C:\\cpp\\MashGraph\\MashGraph\\skybox\\right.jpg",
		"C:\\cpp\\MashGraph\\MashGraph\\skybox\\left.jpg",
		"C:\\cpp\\MashGraph\\MashGraph\\skybox\\top.jpg",
		"C:\\cpp\\MashGraph\\MashGraph\\skybox\\bottom.jpg",
		"C:\\cpp\\MashGraph\\MashGraph\\skybox\\front.jpg",
		"C:\\cpp\\MashGraph\\MashGraph\\skybox\\back.jpg",
	};
